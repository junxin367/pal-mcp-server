...
class TestModelSelection:
    ...
    def test_extended_reasoning_with_gemini_only(self):
        ...
        with patch.dict(os.environ, {"GOOGLE_API_KEY": "test-key"}, clear=False):
            ...
            assert model in ["gemini-3.1-pro-preview", "gemini-3.5-flash", "gemini-flash", "gemini-2.5-flash"]
    ...
    def test_fast_response_with_gemini_only(self):
        ...
        with patch.dict(os.environ, {"GOOGLE_API_KEY": "test-key"}, clear=False):
            ...
            assert model in ["gemini-flash", "gemini-3.5-flash", "gemini-2.5-pro", "gemini-2.5-flash"]
