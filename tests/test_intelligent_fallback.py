...
class TestIntelligentFallback:
    ...
    def test_prefers_openai_when_available(self):
        """Test that GPT-5.5 is preferred when OpenAI API key is available."""
    ...
    def test_prefers_gemini_flash_when_openai_unavailable(self):
        """Test that gemini-flash is used when only Gemini API key is available."""
