...
class TestAutoModeComprehensive:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                ...
                {
                    "EXTENDED_REASONING": "grok-4.3",
                    "FAST_RESPONSE": "grok-build-0.1",
                    "BALANCED": "grok-4.3",
                },
            ),
    ...
    def test_model_availability_with_restrictions(self):
        ...
        provider_config = {
            ...
            "OPENROUTER_API_KEY": None,
            "DEFAULT_MODEL": "auto",
            "OPENAI_ALLOWED_MODELS": "gpt-5.4-mini",  # Restrict OpenAI to current mini model
        }
